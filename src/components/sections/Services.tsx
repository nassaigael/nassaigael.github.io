    ...
    return (
        <section id="services" className="relative py-20 md:py-32 overflow-hidden px-4 sm:px-6 lg:px-16">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-cyan-500/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
                    ...
                    {services.map((service, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Carte principale */}
                                <div className={cn(
                                    "relative p-6 rounded-2xl neumorph-sm transition-all duration-300 h-full flex flex-col",
                                    "bg-neumorph-bg hover:bg-neumorph-bg-hover",
